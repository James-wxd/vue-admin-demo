<template>
  <div class="dashboard-container">
    ...
    <!-- <div ref="testEcharts" style="width: 600px;height:400px;" />
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imageError="option" :src="userInfo.staffPhoto">
          </div>
    ...
    <button type="submit" @click="testVuex">test</button>
    <div class="buttom">
      <p class="'buttom-font'">
        copyright@ 科顿科技版权所有
      </p>
...
export default {
  ...
  components: { radar, Calendar },
  data() {
    return {
      option: require('@/assets/common/img.jpeg'),
      options: {
        title: {
          text: 'ECharts 入门示例'
        },
  ...
  methods: {
    test() {
      ...
      // this.this.$refs.testEcharts
      const myChart = this.$echarts.init(this.$refs.testEcharts)
